...
export default async function Projects() {
  ...
  return (
    <section className="w-full flex flex-col items-start justify-center gap-4 p-4 pt-16 bg-slate-900 text-white">
      <div className="flex flex-col items-start justify-center gap-2 mb-4 w-full flex-wrap">
        <h1>Projects</h1>
        <p>Here are some of my projects:</p>
      </div>
      <div className="w-full h-full flex items-center justify-center gap-4 flex-wrap overflow-x-hidden px-16 flex-1 grow">
